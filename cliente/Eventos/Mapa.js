...
class Mapa {
    ...
    getPosicion(posicion){
        ...
        this.longitud         = this.getLongitud; 
        this.latitud          = this.getLatitud;
    ...
    verTodo(loc){
        var ubicacion=document.getElementById(loc);
    ...
    getMapa(loc, lat, lon, ciu){
        ...
        imagen.innerHTML = "<img src='../Eventos/"+ciu+"_event.jpg' alt='Imagen de Raditz' />";
    }
}
var mapa = new Mapa();